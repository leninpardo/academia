...
jQuery("#wowslider-container1").wowSlider({
    effect:"blinds",prev:"",next:"",duration:20*100,delay:20*100,width:960,height:360,
    autoPlay:true,playPause:true,stopOnHover:false,loop:false,bullets:0,caption:true,
    captionEffect:"move",controls:true,onBeforeStep:0,
    images:[{src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes",descr:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes",descr:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes",descr:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes",descr:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Tarapoto",descr:"Tarapoto"}]});