...
jQuery("#wowslider-container1").wowSlider({
    ...
    images:[{src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Nuestros Docentes"},
            {src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Nuestros Ingresantes"},
            {src:url+"lib/img/05.jpg",title:"Tarapoto"}]});