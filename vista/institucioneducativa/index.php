        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
               ...
               <td><?php echo $this->datos[$i]['CURRICULA'] ?></td>
                ...
                <td>
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>institucioneducativa/editar/<?php echo $this->datos[$i]['INSTITUCIONEDUCATIVA_ID'] ?>')" class="btn btn-success"><i class="icon-pencil icon-white"></i> Editar</a>
...
<div class="navbar-inner">
        <p>No hay Horario</p>
        <a href="<?php echo BASE_URL?>institucioneducativa/nuevo" class="btn btn-primary">Nuevo</a>
    <?php } ?>
