...
<p><h3>Administrar caja</h3></p>
    <p>
        ...
        <a  class="btn btn-inverse" id="ap_caja">Aperturar caja</a>
    </p>
    <div id="grilla">
    <table id="table" class="table table-striped table-bordered table-hover sortable">
        ...
        <?php foreach  ($this->datos as $k) { ?>
            <tr>
                ...
                <td><?php echo $k[2] ?></td>
                <td><?php echo $k[3] ?></td>
                <td><?php if($k[4]==2){ if($k[2]==$k[5]){ echo "<a href='javascript:void(0)' onclick='reaperturar($k[0])'>Reaperturar</a>"; }else{ echo ":::::::::::::"; } } elseif($k[4]==1){echo "<a href='javascript:void(0)' onclick='cerrar($k[0])'>Cerrar</a>"; } ?></td>
