...
$chart->title->text = utf8_decode("MATRICULAS MENSUALES DE LA ACADEMIA ABIERTA ");

$chart->xAxis->categories = array("Ene", "Feb", "Mar", "Abr", "May", "Jun",
                                  "Jul", "Aug", "Sep", "Oct", "Nov", "Dec");

$chart->yAxis->min = 0;
$chart->yAxis->title->text = "Matricula en S/.";
...
$chart->series[] = array('name' => "Dinero Por Matricula por Mes",
