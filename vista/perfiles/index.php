...
<p><h3>Lista de Perfiles</h3></p>
    <p>
        ...
        <a href="<?php echo BASE_URL?>perfiles/nuevo" class="btn btn-inverse">Nuevo</a>
    </p>
    <div id="grilla">
    <table id="table" class="table table-striped table-bordered table-hover sortable">
        ...
        <?php for ($i = 0; $i < count($this->datos); $i++) { ?>
            <tr>
                ...
                <td>
                    <a href="javascript:void(0)" onclick="editar('<?php echo BASE_URL?>perfiles/editar/<?php echo $this->datos[$i]['ID_PERFIL'] ?>')" class="btn btn-success"><i class="icon-pencil icon-white"></i> Editar</a>
                    <a href="javascript:void(0)" onclick="eliminar('<?php echo BASE_URL?>perfiles/eliminar/<?php echo $this->datos[$i]['ID_PERFIL'] ?>')" class="btn btn-danger"><i class="icon-remove icon-white"></i> Eliminar</a>
                </td>
            </tr>
        <?php } ?>
        </tbody>
...
<div class="navbar-inner">
        <p>No hay perfiles</p>
        <a href="<?php echo BASE_URL?>perfiles/nuevo" class="btn btn-primary">Nuevo</a>
    <?php } ?>